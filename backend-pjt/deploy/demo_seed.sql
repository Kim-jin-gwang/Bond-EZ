...
FROM (
    VALUES
        ('KR9000000001', '특수채', 'D000001', '한국전력공사채권 더미1', '한전더미1', '한국전력공사', '2023-06-12'::date, '2026-06-12'::date, 4.0600, 140000000000, 'NH투자증권', '이표채', '이표채 고정금리', 6, '2026-06-15'::date, 100.0000, '만기상환', '만기 원금 100% 상환', '선순위', 'NONE', NULL::date, '무보증', 'AAA'),
        ('KR9000000002', '금융채', 'D000002', '한국수출입금융 2507마-할인-335', '수출입2507마', '한국수출입은행', '2025-07-15'::date, '2026-06-17'::date, 2.4100, 300000000000, '한국투자증권', '할인채', '할인채', 12, '2026-12-15'::date, 100.0000, '만기상환', '할인 발행 후 만기 일시 상환', '선순위', 'NONE', NULL::date, '국가보증', 'AAA'),
        ...
        ('KR9000000007', '회사채', 'D000007', '아진산업 21(사모/콜)', '아진산업21', '아진산업', '2025-06-16'::date, '2026-06-16'::date, 5.4000, 20000000000, '미래에셋증권', '이표채', '이표채 고정금리', 1, '2026-01-15'::date, 100.0000, '만기상환', '발행회사 콜옵션 행사 가능', '선순위', 'CALL', '2027-06-15'::date, '무보증', 'BBB+'),
        ('KR9000000008', '유동화SPC채', 'D000008', '네오드림소프트 1-3', '네오드림1-3', '네오드림소프트', '2024-06-15'::date, '2026-06-15'::date, 4.9500, 45000000000, '하나증권', '이표채', '이표채 고정금리', 3, '2026-03-15'::date, 100.0000, '만기상환', '유동화 SPC 선순위 채권', '선순위', 'NONE', NULL::date, '보증', 'A'),
        ('KR9000000009', '회사채', 'D000009', '삼일제약 18BW(사모/신/풋)', '삼일제약18BW', '삼일제약', '2023-06-15'::date, '2026-06-15'::date, 0.0000, 15000000000, '유진투자증권', '복리채', '복리채 만기일시', 12, '2026-12-31'::date, 100.0000, '만기상환', '투자자 풋옵션 행사 가능', '선순위', 'PUT', '2026-12-15'::date, '무보증', 'A-'),
        ('KR9000000010', '유동화SPC채', 'D000010', '하나금융25호기업인수목적 1CB', '하나금융25CB', '하나금융25호기업인수목적', '2025-06-14'::date, '2026-06-14'::date, 0.0000, 19883500000, '하나증권', '이표채', '이표채 고정금리', 3, '2026-03-15'::date, 100.0000, '만기상환', '전환권 및 조기상환 조건 확인 필요', '선순위', 'NONE', NULL::date, '무보증', 'BBB0'),
...
FROM (
    VALUES
        ('KR9000000001', '2026-06-21'::date, 10018.00, 4.120, 0.4800, 0.1200, 1320000000, 9985, 4.120, 4.020, 0.0400),
        ('KR9000000002', '2026-06-21'::date, 9972.00, 3.080, 0.9200, 0.0800, 2650000000, 9920, 3.080, 2.980, -0.0300),
        ('KR9000000003', '2026-06-21'::date, 10000.00, 6.920, 0.9100, 3.1200, 690000000, 8050, 6.920, 6.560, 0.0000),
        ('KR9000000004', '2026-06-21'::date, 10032.00, 3.310, 4.1000, 0.0000, 8610000000, 9990, 3.310, 3.260, -0.0600),
        ('KR9000000005', '2026-06-21'::date, 9984.00, 5.680, 7.2000, 2.3600, 590000000, 8070, 5.680, 5.470, 0.3100),
        ('KR9000000006', '2026-06-21'::date, 10011.00, 4.360, 2.8000, 0.8700, 1870000000, 9960, 4.360, 4.210, -0.2200),
        ('KR9000000007', '2026-06-21'::date, 10004.00, 5.550, 0.7600, 1.8500, 420000000, 9700, 5.550, 5.320, 0.1200),
        ('KR9000000008', '2026-06-21'::date, 9996.00, 5.110, 0.9800, 1.4200, 360000000, 9640, 5.110, 4.880, -0.0800),
        ('KR9000000009', '2026-06-21'::date, 9860.00, 6.150, 0.8200, 2.0800, 210000000, 9300, 6.150, 5.900, 0.1800),
        ('KR9000000010', '2026-06-21'::date, 9955.00, 5.740, 0.3900, 2.2200, 180000000, 9180, 5.740, 5.500, -0.1100),
        ('KR9000000011', '2026-06-21'::date, 10021.00, 5.980, 1.5400, 2.4800, 310000000, 9410, 5.980, 5.720, 0.0700),
        ('KR9000000012', '2026-06-21'::date, 10008.00, 4.470, 2.1200, 0.9600, 1480000000, 9890, 4.470, 4.310, 0.0200),
        ('KR9000000013', '2026-06-21'::date, 10015.00, 3.960, 2.5600, 0.2100, 2240000000, 10010, 3.960, 3.850, -0.0100),
        ('KR9000000014', '2026-06-21'::date, 9979.00, 6.240, 5.9000, 2.7500, 280000000, 8990, 6.240, 5.980, 0.2500),
        ('KR9000000015', '2026-06-21'::date, 10035.00, 6.480, 1.4300, 2.9800, 330000000, 9100, 6.480, 6.220, 0.1900),
        ('KR9000000016', '2026-06-21'::date, 10007.00, 3.740, 2.3500, 0.1600, 3260000000, 10020, 3.740, 3.650, -0.0200),
        ('KR9000000017', '2026-06-21'::date, 9992.00, 5.420, 1.2400, 1.9600, 240000000, 9500, 5.420, 5.190, -0.0500),
        ('KR9000000018', '2026-06-21'::date, 10002.00, 5.630, 1.1000, 2.0700, 275000000, 9480, 5.630, 5.370, 0.0900),
        ('KR9000000019', '2026-06-21'::date, 10019.00, 4.980, 1.7200, 1.1500, 460000000, 9705, 4.980, 4.790, 0.0500),
        ('KR9000000020', '2026-06-21'::date, 10045.00, 3.520, 6.8500, 0.0000, 12400000000, 10030, 3.520, 3.470, 0.0300)
) AS v(
    isin_code,
    base_date,
    price,
...
FROM (
    VALUES
        ('연합뉴스', '국고채 금리, 장기물 중심으로 상승 마감', 'https://example.com/news/bond-yields-policy', '기준금리 동결 전망 속에 국고채 10년물 금리가 상승하며 장기물 중심으로 채권 가격 부담이 커졌다.', '2026-06-17 09:30:00+09'::timestamptz),
        ('한국경제', '회사채 시장, 우량 등급 중심으로 수요 회복', 'https://example.com/news/corporate-bond-demand', 'AA급 이상 우량 회사채에 기관 수요가 몰리며 발행사들의 자금 조달 여건이 개선되고 있다.', '2026-06-17 11:10:00+09'::timestamptz),
        ('매일경제', 'AA급 신용 스프레드 축소', 'https://example.com/news/credit-spread-aa', 'AA등급 회사채와 국고채 간 신용 스프레드가 소폭 축소되며 크레딧 시장 투자심리가 안정되고 있다.', '2026-06-18 08:50:00+09'::timestamptz),
        ('서울경제', '개인투자자, 장외 채권 순매수 사상 최대', 'https://example.com/news/retail-bond-buying', '금리 고점 인식이 확산되며 개인투자자의 장외 채권 순매수 규모가 월간 기준 사상 최대를 기록했다.', '2026-06-18 14:20:00+09'::timestamptz),
        ('연합뉴스', '여전채 발행 재개 조짐…현대캐피탈 수요예측 흥행', 'https://example.com/news/card-bond-demand', '현대캐피탈 회사채 수요예측에 목표액의 세 배가 넘는 자금이 몰리며 여전채 발행 시장이 회복 조짐을 보였다.', '2026-06-19 10:05:00+09'::timestamptz)
