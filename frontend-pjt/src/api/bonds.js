...
function normalizeBond(item) {
  ...
  return {
    ...
    substitutePrice: formatNumber(market.substitute_price, '-'),
    change: formatPercent(market.price_change_rate, '-', true),
    priceChangeRate: toNumber(market.price_change_rate, base.priceChangeRate),
    volume: formatCompactAmount(market.trading_volume, '-'),
    tradingVolume: toNumber(market.trading_volume, base.tradingVolume),
    buyYield: formatPercent(market.bid_yield, '-'),
    yieldValue: toNumber(market.bid_yield, base.yieldValue),
    sellYield: formatPercent(market.ask_yield, '-'),
    ytm: formatPercent(market.ytm, '-'),
    duration: formatYears(market.duration, '-'),
